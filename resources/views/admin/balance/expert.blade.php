						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">{{ __('general.experts balance') }}</h4>
									...
									<table id="example" class="table text-md-nowrap">
										...
										<tbody>
											...
											<tr>
												...
												<td>{{ $expert->cash_balance }}</td>
												<td>{{ $expert->cash_balance_todate }}</td>
                                                <td>
												 <a href="{{url('admin/balance/expert',$expert->id)}}"  class="btn btn-success btn-sm" title="التفاصيل"><i class="fa fa-info"></i></a>                                                   
