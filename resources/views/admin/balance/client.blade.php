						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">{{ __('general.clients balance') }}</h4>
									...
									<table id="example" class="table text-md-nowrap">
										...
										<tbody>
											...
											<tr>
												...
												<td>{{ $client->points_balance }}</td>												
                                                <td>
													<a href="{{url('admin/balance/client', $client->id)}}"  class="btn btn-success btn-sm" title="التفاصيل"><i class="fa fa-info"></i></a>                                                   
                                                </td>
											</tr>
											@endforeach
									</tbody>
